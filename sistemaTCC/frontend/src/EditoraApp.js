...
RegistrarOperacao(){
      ...
      const apiURL = 'http://192.168.18.6:8080/Editora/adicionar';
   ...
   return  (<div>
                                         <form>
                                                     <div> 
                                                        ...
                                                        <h2  style={{ color :"gray", fontFamily:"Times"}}>Cadastro de Editoras </h2><br/><br/>
                              ...
                              <input type="button" className="btn btn-primary" value="adicionar editora" onClick={() =>this.RegistrarOperacao()}/ ><br/><br/>
